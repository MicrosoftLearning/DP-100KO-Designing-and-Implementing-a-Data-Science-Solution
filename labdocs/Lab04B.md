...
데이터 세트를 사용하면 실험 및 학습용으로 데이터를 캡슐화할 수 있습니다. 테이블 형식 데이터 세트와 파일 데이터 세트를 사용하여 실험에서 쉽게 사용 가능한 버전이 있는 데이터 원본을 정의할 수 있습니다.
...
이 작업에서는 Notebook의 코드를 통해 테이블 형식 데이터 세트와 파일 데이터 세트를 사용해 봅니다.
...
3. Jupyter 홈 페이지의 **Users/DP100** 폴더에서 **04B - Working with Datasets.ipynb** Notebook을 엽니다. 그런 다음 각 코드 셀을 차례로 실행하여 Notebook의 메모를 읽습니다.
