# 랩 10A: Application Insights를 사용해 모델 모니터링
...
## 작업 1: Application Insights를 사용해 모델 모니터링

이 작업에서는 모델을 서비스로 배포하고 Azure Application Insights를 사용하여 해당 모델을 모니터링합니다.
...
3. Jupyter 홈 페이지의 **Users/DP100** 폴더에서 **10A - Monitoring a Model.ipynb** Notebook을 엽니다. 그런 다음 각 코드 셀을 차례로 실행하여 Notebook의 메모를 읽습니다.
