...
파이프라인을 만든 후에는 REST 엔드포인트를 게시할 수 있습니다. 이 엔드포인트를 통해 파이프라인을 시작할 수 있습니다. 그러면 파이프라인을 요청 시에 실행하거나 예약된 시간에 실행할 수 있습니다.

## 시작하기 전에

이 랩을 시작하기 전에 [랩 1A](Lab01A.md) 및 [랩 1B](Lab01B.md)를 완료해야 합니다. 이 두 랩에는 이 랩에서 사용되는 Azure Machine Learning 작업 영역 및 기타 리소스를 만드는 작업이 포함되어 있습니다. 또한 이 랩에서 게시할 파이프라인을 만드는 [랩 6A](Lab06A.md)도 완료해야 합니다.
...
3. Jupyter 홈 페이지의 **Users/DP100** 폴더에서 **06B - Publishing a Pipeline.ipynb** Notebook을 엽니다. 그런 다음 각 코드 셀을 차례로 실행하여 Notebook의 메모를 읽습니다.
