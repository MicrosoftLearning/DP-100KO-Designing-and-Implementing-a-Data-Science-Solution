# 랩 9A: 자동화된 Machine Learning 설명 검토

자동화된 Machine Learning을 사용하여 모델을 학습시킬 때는 기능 중요도의 설명을 생성하도록 실험을 구성할 수 있습니다.
...
## 작업 1: 자동화된 Machine Learning 모델용 기능 중요도 검토

이 작업에서는 자동화된 Machine Learning 실험에서 생성된 기능 중요도 정보를 살펴봅니다.
...
3. Jupyter 홈 페이지의 **Users/DP100** 폴더에서 **09A - Reviewing Automated Machine Learning Explanations.ipynb** Notebook을 엽니다. 그런 다음 각 코드 셀을 차례로 실행하여 Notebook의 메모를 읽습니다.
